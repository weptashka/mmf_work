//1.15. Г={a,b}. Пусть слово P имеет нечетную длину. Удалить из него средний
//        символ.

//Заменить крайние символы на метку и постепенно смещать ее к середине
//до тех пор пока не останется 1 символ между ними
//или не останется символов вообще.. . это если количество символов четное.. . ну в таком случае сам решай какое из них удалять.. .
//        ___aaaaaaaaa___
//        ___kaaaaaaak___
//        ___akaaaaaka___
//        ___aakaaakaa___
//        ___aaakakaaa___
//        ___aaaa_aaaa___
// вместо a будет 1, а вместо b - 2, но у нас ограниченное количество символов(((
// только a, b и _ ((((
...
public class TuringMachine1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Inter " + (n-2) + " symbols - 'a' or 'b' :");
        for (int i = 1; i < n - 1; i++) {
